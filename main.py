...
def update_course_time(dayoverride: typing.Optional[int] = None):
    ...
    lunchtimes = {}
    if day == 0:
        coursetimes.append({"starttime": datetime.time(7, 0), "endtime": datetime.time(7, 50), "period": 1, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(7, 50), "endtime": datetime.time(9, 30), "period": 2, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(9, 30), "endtime": datetime.time(11, 10), "period": 4, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(11, 10), "endtime": datetime.time(13, 15), "period": 6, "lunchactive": True})
        coursetimes.append({"starttime": datetime.time(13, 15), "endtime": datetime.time(14, 55), "period": 8, "lunchactive": False})
        ...
        coursetimes.append({"starttime": datetime.time(7, 0), "endtime": datetime.time(7, 50), "period": 1, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(7, 50), "endtime": datetime.time(9, 30), "period": 3, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(9, 30), "endtime": datetime.time(11, 10), "period": 5, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(11, 10), "endtime": datetime.time(13, 15), "period": 7, "lunchactive": True})
        coursetimes.append({"starttime": datetime.time(13, 15), "endtime": datetime.time(14, 55), "period": 9, "lunchactive": False})
        lunchtimes["A"] = (datetime.time(11,15), datetime.time(11,45))
        lunchtimes["B"] = (datetime.time(12,0), datetime.time(12,30))
        lunchtimes["C"] = (datetime.time(12,45), datetime.time(13,15))
    elif day == 2:
        coursetimes.append({"starttime": datetime.time(7, 0), "endtime": datetime.time(7, 50), "period": 1, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(7, 50), "endtime": datetime.time(9, 5), "period": 2, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(9, 5), "endtime": datetime.time(10, 25), "period": 4, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(10, 25), "endtime": datetime.time(11, 40), "period": 4.5, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(11, 40), "endtime": datetime.time(13, 35), "period": 6, "lunchactive": True})
        coursetimes.append({"starttime": datetime.time(13, 35), "endtime": datetime.time(14, 55), "period": 8, "lunchactive": False})
        ...
        coursetimes.append({"starttime": datetime.time(7, 0), "endtime": datetime.time(7, 50), "period": 1, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(7, 50), "endtime": datetime.time(9, 5), "period": 3, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(9, 5), "endtime": datetime.time(10, 25), "period": 5, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(10, 25), "endtime": datetime.time(11, 40), "period": 4.5, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(11, 40), "endtime": datetime.time(13, 35), "period": 7, "lunchactive": True})
        coursetimes.append({"starttime": datetime.time(13, 35), "endtime": datetime.time(14, 55), "period": 9, "lunchactive": False})
        lunchtimes["A"] = (datetime.time(11,45), datetime.time(12,15))
        lunchtimes["B"] = (datetime.time(12,25), datetime.time(12,55))
        lunchtimes["C"] = (datetime.time(13,5), datetime.time(13,35))
        ...
        coursetimes.append({"starttime": datetime.time(7, 0), "endtime": datetime.time(7, 50), "period": 1, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(7, 50), "endtime": datetime.time(8, 35), "period": 2, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(8, 35), "endtime": datetime.time(9, 20), "period": 3, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(9, 20), "endtime": datetime.time(10, 5), "period": 4, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(10, 5), "endtime": datetime.time(10, 50), "period": 5, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(10, 50), "endtime": datetime.time(12, 40), "period": 6, "lunchactive": True})
        coursetimes.append({"starttime": datetime.time(12, 40), "endtime": datetime.time(13, 25), "period": 7, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(13, 25), "endtime": datetime.time(14, 10), "period": 8, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(14, 10), "endtime": datetime.time(14, 55), "period": 9, "lunchactive": False})
        ...
        coursetimes.append({"starttime": datetime.time(7, 0), "endtime": datetime.time(7, 50), "period": 1, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(7, 50), "endtime": datetime.time(8, 45), "period": 2, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(8, 45), "endtime": datetime.time(9, 40), "period": 4, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(9, 40), "endtime": datetime.time(11, 25), "period": 6, "lunchactive": True})
        coursetimes.append({"starttime": datetime.time(11, 25), "endtime": datetime.time(12, 20), "period": 8, "lunchactive": False})
        ...
        coursetimes.append({"starttime": datetime.time(7, 0), "endtime": datetime.time(7, 50), "period": 1, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(7, 50), "endtime": datetime.time(8, 45), "period": 3, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(8, 45), "endtime": datetime.time(9, 40), "period": 5, "lunchactive": False})
        coursetimes.append({"starttime": datetime.time(9, 40), "endtime": datetime.time(11, 25), "period": 7, "lunchactive": True})
        coursetimes.append({"starttime": datetime.time(11, 25), "endtime": datetime.time(12, 20), "period": 9, "lunchactive": False})
        lunchtimes["A"] = (datetime.time(9,45), datetime.time(10,15))
        lunchtimes["B"] = (datetime.time(10,20), datetime.time(10,50))
        lunchtimes["C"] = (datetime.time(10,55), datetime.time(11,25))
    else:
